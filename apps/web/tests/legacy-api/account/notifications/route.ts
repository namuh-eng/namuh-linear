...
import {
  createHeadlessAccountNotificationsClient,
  headlessAccountNotificationsEnabled,
...
export async function GET() {
  ...
  if (headlessAccountNotificationsEnabled()) {
    ...
    const client = createHeadlessAccountNotificationsClient(token);
