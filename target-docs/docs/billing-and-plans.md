...
Linear's Education Program offers discounted plans for eligible students and staff at qualifying academic institutions.

**Discount**

* **Full-time students** receive a **100% discount** (free access for one year).
* **University staff and employees** receive a **75% discount**.

Discounts apply to our **Basic** and **Business** paid plans.

**Eligibility**

The Education Program is open to colleges and higher-level educational institutions. The following are **not** eligible:

* High schools
* For-profit or online-only educational institutions

**How to apply**

Email [support@linear.app](mailto:support@linear.app) from your `.edu` address to apply. To help expedite your application, include one or more of the following:

* Proof of full time enrollment as a student (we do not accept student IDs as proof) or proof of employment
* Proof of your institution’s accreditation with a governing organization

### Non-profit program

We offer 75% off our **Basic** and **Business** paid plans only (not available on Enterprise) to eligible charities (otherwise known as NonProfits). Please reach out to us at support@linear.app to apply and provide proof of nonprofit status.
