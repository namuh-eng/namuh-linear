...
You can also create labels in the _Add label_ flow. Take the action to apply a label, then type the name of the label you want to create. You will have the option to create the label at the workspace level or for your team.
