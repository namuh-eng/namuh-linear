...
Reminders are sent for _active_ Initiatives and Projects with statuses in the _In Progress_ category, and only to the Initiative owner or project lead. If an update isn’t made after the initial reminder, follow-up nudges will be sent 1 working day later, and 2 working days after this.
