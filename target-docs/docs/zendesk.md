...
1. Install and approve Linear for your Zendesk workspace by [installing it](https://www.zendesk.com/marketplace/apps/support/431018/linear/) from Zendesk Marketplace. This will add the Linear widget to your Zendesk ticket sidebar.
...
Linear admins can designate up to 10 templates to be available for quick use from within the Linear integration in Zendesk. Selecting any of these templates will pre-fill issue property fields appropriately, helping to speed up issue creation and maintain a high level of data hygiene in your issues.
