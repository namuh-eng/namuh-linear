...
**Private team:** On Enterprise plans, only _workspace owners_ can see all private teams in [Settings > Administration > Teams](https://linear.app/settings/teams), update team settings, or join a private team by adding themselves as a member. Workspace admins cannot view private teams unless they are already members.
